...
//Ki�rja a param�terk�nt megadott k�p pixeleinek rgb �rt�k�t egy param�terk�nt megadott file-ba. (lehet az stdout-is)
        ...
        for (int i = 0; i < img->height; i++)
        {
            for (int j = 0; j < img->width; j++)
            {
                ...
                if(img->type == PBM_BINARY || img->type == PBM_ASCII){
                    //.pbm eset�n 0 a feh�r, �s 1 a fekete
...
//Elmenti a k�pet egy param�terk�nt megadott n�vvel, aminek a fajl kiterjeszt�se, �s a k�p adata a param�terk�nt kapott Img v�ltoz�ban van benne
...
//Megn�zi, hogy egy sor komment e
...
//Egy PBM file tulajdons�gait t�lti be.
...
//Egy PPM/PGM file tulajdons�gait t�lti be.
...
//Egy ascii form�tum� PBM/PGM file pixeleinek adatait t�lti be.
...
//Egy ascii form�tum� PPM file pixeleinek adatait t�lti be.
...
//Egy bin�ris form�tum� PBM file pixeleinek adatait t�lti be.
...
//Egy bin�ris form�tum� PGM file pixeleinek adatait t�lti be.
...
//Egy bin�ris form�tum� PPM file pixeleinek adatait t�lti be.
...
//beolvas egy k�pet egy param�terk�nt megadott helyr�l, majd elmenti a param�terk�nt megadott pointerbe
int readImg(char* img_location, Img* img) {
    ...
    if (fp != NULL) {
        ...
        //K�p tulajdons�gainak bet�lt�se
